    ...
    Game.prototype.render = function () {
        return (react_1["default"].createElement("div", null,
            react_1["default"].createElement("div", { className: "game" },
                ...
                react_1["default"].createElement(Grid_1["default"], { mines: this.state.mines, height: this.state.gridHeight, width: this.state.gridWidth, updateFlagCount: this.updateFlagCount, startCounting: this.startCountingTime, stopCountingTime: this.stopCountingTime }))));
    };
    return Game;
