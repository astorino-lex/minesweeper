...
var Sqaure = /** @class */ (function (_super) {
    ...
    Sqaure.prototype.render = function () {
        ...
        return (react_1["default"].createElement("div", { className: "sqaure", style: { height: medium ? '30px' : '52px', fontSize: medium ? '18px' : '25px', textAlign: 'center' }, onClick: function () { return _this.props.onLeftClick(row, column); }, onContextMenu: function (e) { return _this.props.onRightClick(row, column, e); } }, this.props.exploded && this.props.data.isMine ?
